$(window).on('load', function () {
	...
	var $employeeChart = document.querySelector('#employee-chart');
	var $branchChart = document.querySelector('#branch-chart');
	var $productChart = document.querySelector('#product-chart');
	var $supplyChart = document.querySelector('#supply-chart');
	...
	var name = document.getElementById('useraccountname');
  	...
  	employeeChart = new ApexCharts($employeeChart, employeeChartOptions);
  	...
  	branchChart = new ApexCharts($branchChart, branchChartOptions);
  	branchChart.render();
  	...
  	supplyChart = new ApexCharts($supplyChart, supplyChartOptions);
  	supplyChart.render();
