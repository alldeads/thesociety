<section>
  	<div class="bs-stepper vertical vertical-wizard-example">
		<div class="bs-stepper-header">
	  		...
	  		<div wire:ignore>
				<button class="btn btn-success" wire:click="edit">Edit Supplier</button>
	  		</div>
		</div>
	  		...
	  		<div id="account-details-vertical" class="content" wire:ignore>
				...
				<div class="row">
		  			<div class="form-group col-md-6">
						...
						<input type="text" id="company-name" class="form-control" readonly wire:model="inputs.company" />
		  			</div>
	  		...
	  		<div id="personal-info-vertical" class="content" wire:ignore>
				...
				<div class="row">
		  			<div class="form-group col-md-6">
						...
						<input type="text" id="vertical-contact_phone" class="form-control" readonly wire:model="inputs.contact_phone"/>
		  			</div>

		  			<div class="form-group col-md-6">
						<label class="form-label" for="vertical-contact_email">Contact Email</label>
						<input type="email" id="vertical-contact_email" class="form-control" readonly wire:model="inputs.contact_email"/>
		  			</div>
				</div>
