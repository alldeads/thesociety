					...
					<div class="row">
						...
						<div class="col-12">
            				<div class="form-group">
            					...
            					<input type="text" id="balance" class="form-control" wire:model.defer="inputs.balance" readonly>
            				</div>
          				</div>
						...
						<div class="col-md-6 col-12">
							<div class="form-group">
								...
								<select class="form-control @error('movement') is-invalid @enderror" id="movement" wire:model.defer="inputs.movement" {{ $last->id != $cashflow->id ? "disabled" : "" }}>
						...
						<div class="col-md-6 col-12">
							<div class="form-group">
								...
								<input type="number" wire:model.defer="inputs.amount" id="amount" class="form-control @error('amount') is-invalid @enderror" {{ $last->id != $cashflow->id ? "readonly" : "" }}>
						...
						<div class="col-12">
							<button wire:click.prevent="save" class="btn btn-primary mr-1 mt-1">{{ __('Update') }}</button>
